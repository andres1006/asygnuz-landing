        ...
        <div ref={containerRef}>
            ...
            {!isAudioReady ? (
                <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
                    ...
                    >
                        <motion.div animate={{ rotate: 360 }} transition={{ duration: 60, repeat: Infinity, ease: "linear" }}
                            className="absolute w-[500px] h-[500px] rounded-full border border-[#183057]/[0.08] pointer-events-none" />
                        <motion.div animate={{ rotate: -360 }} transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
                            className="absolute w-[380px] h-[380px] rounded-full border border-[#183057]/[0.05] pointer-events-none" />

                        <p className="text-[10px] font-mono tracking-[0.8em] text-[#1a1a2e]/30 uppercase">Asygnuz S.A.S. presenta</p>

                        <div className="text-center leading-[0.85]" style={{ fontFamily: "'Inter', sans-serif" }}>
                            <span className="block text-6xl md:text-9xl lg:text-[140px] font-black text-[#1a1a2e]/[0.06] tracking-[-0.03em]">CLAUDIA</span>
                            <span className="block text-6xl md:text-9xl lg:text-[140px] font-black text-[#1a1a2e]/[0.06] tracking-[-0.03em]">URIBE</span>
                        </div>
                        ...
                        >
                            ...
                            <div className="relative px-12 py-5 bg-[#183057] border border-[#183057] rounded-full transition-all duration-500 hover:bg-[#2C4B7D]">
                                <span className="relative text-white font-mono text-xs tracking-[0.4em] uppercase">
                                    Iniciar Experiencia
                                </span>
                            </div>
                        </motion.button>
                        <p className="text-[9px] font-mono text-[#1a1a2e]/20 tracking-[0.4em]">PROPUESTA CONFIDENCIAL — MARZO 2026</p>
                    </motion.div>
                </div>
            ) : (
                ...
                <>
                    ...
                    >
                        <div ref={titleRef} className="flex flex-col items-center px-6 w-full max-w-[1400px]">
                            {/* Floating dots */}
                            <motion.div animate={{ y: [-10, 10, -10], x: [-5, 5, -5] }} transition={{ duration: 6, repeat: Infinity }}
                                className="hero-deco absolute top-[15%] left-[8%] w-2 h-2 rounded-full bg-[#183057]/20" />
                            <motion.div animate={{ y: [10, -10, 10], x: [5, -5, 5] }} transition={{ duration: 8, repeat: Infinity }}
                                className="hero-deco absolute top-[20%] right-[12%] w-3 h-3 rounded-full bg-[#183057]/10" />

                            {/* Badge */}
                            <div className="hero-details mb-8">
                                <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#183057]/20 bg-white/60 backdrop-blur-sm">
                            ...
                            <div className="text-center" style={{ perspective: 800 }}>
                                <div className="hero-line overflow-hidden">
                                    <span className="block text-6xl md:text-[120px] lg:text-[180px] font-black tracking-[-0.04em] leading-[0.85] text-[#1a1a2e]"
                            ...
                            <div className="hero-details mt-8 flex flex-col items-center">
                                ...
                                <p className="hero-sub font-mono text-sm md:text-base tracking-[0.3em] text-[#183057]/50 uppercase">
                                    M.I.A (Claudia Uribe)
                                </p>
                                <p className="hero-sub text-[11px] font-mono tracking-[0.25em] text-[#183057]/30 uppercase mt-2">
                        ...
                        <div className="scroll-indicator absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3">
                            <motion.div animate={{ y: [0, 12, 0] }} transition={{ repeat: Infinity, duration: 2.5, ease: "easeInOut" }}>
                                <div className="w-5 h-8 rounded-full border border-[#183057]/15 flex items-start justify-center p-1.5">
                                    <motion.div
                                        animate={{ y: [0, 8, 0] }}
                            ...
                            <span className="text-[8px] font-mono text-[#1a1a2e]/20 tracking-[0.5em]">SCROLL</span>
                        </div>
                    </div>
