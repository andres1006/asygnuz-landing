...
const TEAM = [
    {
        ...
        description: "Gerente de proyectos de ingeniería con más de 5 años en gobernanza digital y transformación tecnológica.",
        skills: ["TOGAF", "AWS", "PMI/PMBOK", "Python", "TypeScript"],
    },
    {
        initials: "AA",
        image: "/Andres.jpeg",
        ...
        description: "Ingeniero de Sistemas y diseñador con más de 6 años en desarrollo Full Stack y arquitectura de interfaces.",
    ...
    },
    {
        ...
        description: "Estratega en adquisición de tráfico pago y redacción persuasiva. Optimización de presupuestos y conversión.",
        skills: ["Facebook Ads", "Google Ads", "Copywriting", "Sales Funnels", "Analítica"],
    },
    {
        initials: "SG",
        ...
        description: "Especialista en narrativa visual y creación de contenido de alto impacto para marcas personales y corporativas.",
    ...
    },
    {
        ...
        description: "Diseñadora gráfica y estratega de contenido. Gestión de comunidades y diseño de piezas de impacto.",
        skills: ["Illustrator", "Photoshop", "Figma", "Content Strategy", "Social Media"],
    },
    {
        initials: "RL",
        ...
        description: "Diseñador y editor audiovisual enfocado en estética visual y contenido dinámico para canales digitales.",
    ...
    useEffect(() => {
        ...
        const ctx = gsap.context(() => {
            gsap.fromTo(".team-title",
                { opacity: 0, y: 30 },
                { scrollTrigger: { trigger: containerRef.current, start: "top 85%", toggleActions: "play none none none" }, opacity: 1, y: 0, stagger: 0.1, duration: 1, ease: "power3.out" }
            );
            gsap.fromTo(".team-card",
                { opacity: 0, y: 40 },
                { scrollTrigger: { trigger: ".team-grid", start: "top 90%", toggleActions: "play none none none" }, opacity: 1, y: 0, stagger: 0.15, duration: 1.2, ease: "expo.out" }
            );
        }, containerRef);
        return () => ctx.revert();
    }, []);
        ...
        <div ref={containerRef} className="px-6 md:px-12 py-24 w-full max-w-7xl mx-auto">
            <div className="flex flex-col lg:flex-row gap-12 items-center lg:items-end justify-between mb-20">
                <div className="space-y-4 max-w-2xl text-center lg:text-left">
                    ...
                    <h2 className="team-title text-3xl md:text-5xl lg:text-6xl font-black text-[#183057] leading-tight tracking-tight">
                        Las personas <span className="text-[#183057] opacity-60">detrás</span> <br className="hidden md:block" />del trabajo.
                    </h2>
                </div>
                ...
                <div className="team-title bg-[#F8FAFC] p-6 md:p-8 rounded-3xl shadow-lg border border-[#183057]/10 max-w-md relative overflow-hidden group hover:scale-[1.02] transition-transform duration-500">
                    ...
                    <p className="text-[#183057]/60 text-sm md:text-base font-medium leading-relaxed">
                        <span className="text-[#183057] font-bold">Por un costo menor</span> al de un ingeniero senior con prestaciones, integras una <strong className="text-[#183057]">célula directiva completa</strong> de IT, Marketing y Crecimiento Comercial.
                    </p>
                </div>
            </div>
            ...
            <div className="team-grid grid grid-cols-1 md:grid-cols-2 gap-8 w-full mb-16">
                {TEAM.map((member, i) => (
                    ...
                    >
                        ...
                        <div className="flex flex-col md:flex-row gap-6 items-start mb-6 relative z-10">
                        ...
                        <div className="flex flex-wrap gap-2 relative z-10">
                            {member.skills.map((skill, j) => (
                                <span key={j} className="px-3 py-1.5 text-[10px] font-mono tracking-widest uppercase rounded-full border border-[#183057]/10 text-[#183057]/40 bg-white shadow-sm">
                                    {skill}
                                </span>
                            ))}
                        </div>
            ...
            <div className="text-center w-full max-w-3xl mx-auto pt-8 border-t border-[#183057]/5">
                <p className="text-xs md:text-sm text-[#183057]/40 font-mono tracking-[0.1em] leading-relaxed uppercase">
                    + Red de aliados: Trafikkers · Community Managers · Expertos WhatsApp · UI/UX <br className="hidden md:block" />
                    <span className="text-[#183057]/60 font-bold">— Todos bajo arquitectura y gobierno de Asygnuz.</span>
                </p>
            </div>
        </div>
    );
