...
export default function ServicesHero({ isStarted, onStart }: { isStarted: boolean; onStart: () => void }) {
    ...
    useEffect(() => {
        if (!titleRef.current || !isStarted || !fixedTitleRef.current) return;
                ...
                <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#F8FAFC]">
                    ...
                    >
                        ...
                        >
                            ...
                            <p className="text-[10px] font-mono tracking-[0.8em] text-[#183057]/40 uppercase">oferta de servicios</p>
                        </motion.div>

                        <div className="text-center leading-[0.85]" style={{ fontFamily: "'Inter', sans-serif" }}>
                            <span className="block text-6xl md:text-9xl lg:text-[140px] font-black text-[#183057]/[0.9] tracking-[-0.03em]">SERVICIOS</span>
                        ...
                        <p className="text-[9px] font-mono text-[#183057]/80 tracking-[0.4em]">ASYGNUZ S.A.S. — MANIZALES, COLOMBIA — 2026</p>
                    </motion.div>
                </div>
            ) : (
                <>
                        ...
                        <div ref={titleRef} className="flex flex-col items-center px-6 w-full max-w-[1400px] relative z-20">
                            ...
                            <div className="hero-details mb-8">
                                <span className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[#183057]/30 bg-white/60 backdrop-blur-md">
                                    ...
                                    <span className="text-[10px] font-mono tracking-[0.5em] text-[#183057]/60 uppercase">Asygnuz S.A.S. · Oferta 2026</span>
                                </span>
                            </div>

                            <div className="text-center" style={{ perspective: 800 }}>
                                <div className="hero-line overflow-hidden">
                                    <span className="block text-6xl md:text-[130px] lg:text-[180px] font-black tracking-[-0.04em] leading-[0.85] text-[#183057]/90"
                                        style={{ fontFamily: "'Inter', sans-serif" }}>
                                        OFERTA DE
                                    </span>
                                </div>
                                <div className="hero-line overflow-hidden">
                                    <span className="block text-6xl md:text-[130px] lg:text-[180px] font-black tracking-[-0.04em] leading-[0.85] text-[#183057]"
                                        style={{
